...
<p className={`${anton.className} text-[70px] text-blue-blueSoftWater`}>
  CLIENTES
</p>
<div className="w-full flex flex-col justify-center items-center gap-1 mt-4">
  ...
  <div className="w-full flex flex-col justify-center items-center">
    <p className={`${anton.className} text-[25px] text-blue-colorText`}>
    ...
    <p className="mt-8 text-blue-colorText font-[600]">
      ...
      personalizadas para los primeros clientes que confíen en nosotros.
      Llena el formulario y participa por una invitación totalmente
      gratuita para tu evento especial. Nos encargaremos de cada detalle
      con pasión y compromiso, porque entendemos que cada momento merece
      ser inolvidable.
    </p>
  </div>
</div>
